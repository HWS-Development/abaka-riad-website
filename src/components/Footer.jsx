      ...
      <div className="mx-auto max-w-6xl px-4 pb-10 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <address className="not-italic mt-4 space-y-2">
            ...
            <div>
              <a href="mailto:colbail2016@gmail.com" className="hover:underline">
                colbail2016@gmail.com
              </a>
            </div>
          </address>
        ...
        <div className="flex flex-col justify-between">
          ...
          {/* Social icons */}
          <div className="mt-4 flex gap-4 text-xl opacity-90 justify-en">
            <a
              href="https://wa.me/212667815538"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="hover:text-white"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-10 text-white" fill="white">
            ...
            <a
              href="https://www.instagram.com/abakariadbyghali/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/abakariadbyghali"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="hover:text-white"
